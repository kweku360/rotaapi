...
abstract class Projectaccount implements ActiveRecordInterface
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProjectaccountTableMap::translateFieldName('TotalTargetamt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->totaltargetamt = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ProjectaccountTableMap::translateFieldName('Amtoffsite', TableMap::TYPE_PHPNAME, $indexType)];
            $this->amtoffsite = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ProjectaccountTableMap::translateFieldName('Amtraised', TableMap::TYPE_PHPNAME, $indexType)];
            $this->amtraised = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ProjectaccountTableMap::translateFieldName('Donorcount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->donorcount = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ProjectaccountTableMap::translateFieldName('ProjectUuid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->projectuuid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ProjectaccountTableMap::translateFieldName('Clubuuid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->clubuuid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : ProjectaccountTableMap::translateFieldName('Created', TableMap::TYPE_PHPNAME, $indexType)];
            $this->created = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : ProjectaccountTableMap::translateFieldName('Modified', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 11; // 11 = ProjectaccountTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getTotalTargetamt(),
            $keys[4] => $this->getAmtoffsite(),
            $keys[5] => $this->getAmtraised(),
            $keys[6] => $this->getDonorcount(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setTotalTargetamt($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setAmtoffsite($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setAmtraised($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setDonorcount($arr[$keys[6]]);
        }
