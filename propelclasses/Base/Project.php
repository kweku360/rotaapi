...
abstract class Project implements ActiveRecordInterface
{
    ...
    /**
     * The value for the urlcode field.
     * @var        string
     */
    protected $urlcode;
    ...
    /**
     * Get the [startdate] column value.
     *
     * @return string
     */
    ...
    public function setUuid($v)
    {
        ...
        if ($this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[ProjectTableMap::COL_UUID] = true;
        }
    ...
    /**
     * Set the value of [urlcode] column.
     *
     * @param string $v new value
     * @return $this|\Project The current object (for fluent API support)
     */
    public function seturlcode($v)
    {
        ...
        if ($this->urlcode !== $v) {
            $this->urlcode = $v;
            $this->modifiedColumns[ProjectTableMap::COL_URLCODE] = true;
        }
    ...
    public function setCountry($v)
    {
        ...
        if ($this->country !== $v) {
            $this->country = $v;
            $this->modifiedColumns[ProjectTableMap::COL_COUNTRY] = true;
        }
    ...
    public function setCountrycode($v)
    {
        ...
        if ($this->countrycode !== $v) {
            $this->countrycode = $v;
            $this->modifiedColumns[ProjectTableMap::COL_COUNTRYCODE] = true;
        }
    ...
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[ProjectTableMap::COL_CITY] = true;
        }
    ...
    public function setStartdate($v)
    {
        ...
        if ($this->startdate !== $v) {
            $this->startdate = $v;
            $this->modifiedColumns[ProjectTableMap::COL_STARTDATE] = true;
        }
    ...
    public function setClubuuid($v)
    {
        ...
        if ($this->clubuuid !== $v) {
            $this->clubuuid = $v;
            $this->modifiedColumns[ProjectTableMap::COL_CLUBUUID] = true;
        }
    ...
    public function setenddate($v)
    {
        ...
        if ($this->enddate !== $v) {
            $this->enddate = $v;
            $this->modifiedColumns[ProjectTableMap::COL_ENDDATE] = true;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== $v) {
            $this->created = $v;
            $this->modifiedColumns[ProjectTableMap::COL_CREATED] = true;
        }
    ...
    public function setModified($v)
    {
        ...
        if ($this->modified !== $v) {
            $this->modified = $v;
            $this->modifiedColumns[ProjectTableMap::COL_MODIFIED] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProjectTableMap::translateFieldName('Uuid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProjectTableMap::translateFieldName('urlcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->urlcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ProjectTableMap::translateFieldName('status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ProjectTableMap::translateFieldName('Country', TableMap::TYPE_PHPNAME, $indexType)];
            $this->country = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ProjectTableMap::translateFieldName('Countrycode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->countrycode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ProjectTableMap::translateFieldName('City', TableMap::TYPE_PHPNAME, $indexType)];
            $this->city = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ProjectTableMap::translateFieldName('Startdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->startdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : ProjectTableMap::translateFieldName('Clubuuid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->clubuuid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : ProjectTableMap::translateFieldName('enddate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->enddate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : ProjectTableMap::translateFieldName('Created', TableMap::TYPE_PHPNAME, $indexType)];
            $this->created = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : ProjectTableMap::translateFieldName('Modified', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 13; // 13 = ProjectTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProjectTableMap::COL_UUID)) {
            $modifiedColumns[':p' . $index++]  = 'uuid';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_URLCODE)) {
            $modifiedColumns[':p' . $index++]  = 'urlcode';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_COUNTRY)) {
            $modifiedColumns[':p' . $index++]  = 'country';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_COUNTRYCODE)) {
            $modifiedColumns[':p' . $index++]  = 'countrycode';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_CITY)) {
            $modifiedColumns[':p' . $index++]  = 'city';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_STARTDATE)) {
            $modifiedColumns[':p' . $index++]  = 'startdate';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_CLUBUUID)) {
            $modifiedColumns[':p' . $index++]  = 'clubuuid';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_ENDDATE)) {
            $modifiedColumns[':p' . $index++]  = 'enddate';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'created';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_MODIFIED)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'name':
                        ...
                        break;
                    case 'urlcode':
                        $stmt->bindValue($identifier, $this->urlcode, PDO::PARAM_STR);
                        break;
                    case 'status':
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectTableMap::COL_UUID)) {
            $criteria->add(ProjectTableMap::COL_UUID, $this->uuid);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_NAME)) {
            $criteria->add(ProjectTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_URLCODE)) {
            $criteria->add(ProjectTableMap::COL_URLCODE, $this->urlcode);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_STATUS)) {
            $criteria->add(ProjectTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_COUNTRY)) {
            $criteria->add(ProjectTableMap::COL_COUNTRY, $this->country);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_COUNTRYCODE)) {
            $criteria->add(ProjectTableMap::COL_COUNTRYCODE, $this->countrycode);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_CITY)) {
            $criteria->add(ProjectTableMap::COL_CITY, $this->city);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_STARTDATE)) {
            $criteria->add(ProjectTableMap::COL_STARTDATE, $this->startdate);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_CLUBUUID)) {
            $criteria->add(ProjectTableMap::COL_CLUBUUID, $this->clubuuid);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_ENDDATE)) {
            $criteria->add(ProjectTableMap::COL_ENDDATE, $this->enddate);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_CREATED)) {
            $criteria->add(ProjectTableMap::COL_CREATED, $this->created);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_MODIFIED)) {
            $criteria->add(ProjectTableMap::COL_MODIFIED, $this->modified);
        }
